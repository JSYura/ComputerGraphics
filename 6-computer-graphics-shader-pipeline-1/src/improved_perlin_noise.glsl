...
//  return 0;
  ...
  vec3 improve_smooth_st = improved_smooth_step(st - v1);
  float x_15, x_26, x_37, x_48, y_1537, y_2648;
  x_15 = p1 + (improve_smooth_st.x * (p5 - p1));
  x_26 = p2 + (improve_smooth_st.x * (p6 - p2));
  x_37 = p3 + (improve_smooth_st.x * (p7 - p3));
  x_48 = p4 + (improve_smooth_st.x * (p8 - p4));
  y_1537 = x_15 + (improve_smooth_st.y * (x_37 - x_15));
  y_2648 = x_26 + (improve_smooth_st.y * (x_48 - x_26));

  return 3 * (y_1537 + (improve_smooth_st.z * (y_2648 - y_1537))) / 2;
  /////////////////////////////////////////////////////////////////////////////
}
